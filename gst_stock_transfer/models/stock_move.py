        ...
        if self.picking_id.z_interstate_bool == True and self.picking_id.picking_type_id.z_stock_transfer == True:
            if self.picking_id.location_dest_id.z_internal_transfer_bool == True:
                debit_line_vals = {
                    ...
                    'debit': debit_value + self.picking_id.z_amount_tax if debit_value > 0 else 0,
                ...
                igst_line_val = {
                    ...
                    'partner_id': partner_id,
                    'debit': 0,
                    'credit': self.picking_id.z_amount_tax,
            ...
            if self.picking_id.location_id.z_internal_transfer_bool == True:
                ...
                credit_line_vals = {
                    ...
                    'ref': ref,
                    'partner_id': partner_id,
                    'credit': credit_value + self.picking_id.z_amount_tax if credit_value > 0 else 0,
                    'debit': -credit_value if credit_value < 0 else 0,
                    'account_id': credit_account_id,
                    'analytic_tag_ids':analytic_tag_ids,
                    #need to add analytic account id
                ...
                igst_line_val = {
                    ...
                    'ref': ref,
                    'partner_id': partner_id,
                    'debit': self.picking_id.z_amount_tax,
                    'credit': 0,
                    'account_id': self.igst_intransit_account.id,
                    'analytic_tag_ids':analytic_tag_ids,
                    #need to add analytic account id
