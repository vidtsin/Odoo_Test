...
class report_account_aged_partner(models.AbstractModel):
    ...
    def _get_columns_name(self, options):
        ...
        columns += [
            ...
            for v in [_("JRNL"), _("Account"), _("Reference"), _("Sales Office"), _("Not due on: %s") % format_date(self.env, options['date']['date']),
            ...
            if 'partner_%s' % (values['partner_id'],) in options.get('unfolded_lines'):
                for line in amls[values['partner_id']]:
                    ...
                    vals = {
                        ...
                        'columns': [{'name': v} for v in [aml.journal_id.code, aml.account_id.code, self._format_aml_name(aml),aml.invoice_id.z_sale_ofc.name]] +\
