...
class SaleOrder(models.Model):
    ...
    z_order_type = fields.Many2one('sale.order.type',string='Order Type',required=True,store=True)
    z_payment_method = fields.Many2one('custom.fields',string='Payment Method',required=True,store=True ,index=True,ondelete='cascade')
...
class SaleOrderLine(models.Model):
    ...
    def _prepare_invoice_line(self, qty):
        ...
        res = {
            ...
            'z_no_of_package': self.z_no_of_package,
        }
        return res